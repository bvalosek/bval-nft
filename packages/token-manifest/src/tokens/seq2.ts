...
export const seq2Sequence: SequenceSource = {
  ...
  sequenceNumber: 2,
  collectionVersion: 1,
  description: 'A Retrocausal Study of Manifold Collapse',
  image: 'seq2/seq2.png',
  completed: true,
  atomic: true,
};
...
export const seq2Tokens: TokenSource[] = [
  ...
  {
    name: 'Primer',
    description: 'Loopholes persist, even in information space',
  ...
  {
    name: 'Resonance',
    description: 'Matter tuned to an ancient, dying echo',
