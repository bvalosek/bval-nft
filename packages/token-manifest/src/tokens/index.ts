...
import { seq6Sequence, seq6Tokens } from './seq6';

export const tokens = [...archDescentTokens, ...seq2Tokens, ...seq3Tokens, ...seq4Tokens, ...seq5Tokens, ...seq6Tokens];

export const sequences = [archDescentSequence, seq2Sequence, seq3Sequence, seq4Sequence, seq5Sequence, seq6Sequence];
